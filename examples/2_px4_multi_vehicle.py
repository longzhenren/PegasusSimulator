...
simulation_app = SimulationApp({"headless": False, "renderer": "Rasterization"})
...
class PegasusApp:
    ...
    def __init__(self):
        ...
        self.pg.load_environment("/home/user/Downloads/Demos/AEC/BrownstoneDemo/World_BrownstoneDemopack_Morning(20Gb).usd")
        self.initial_position = [-89.0, 8.0, 0.07]
    ...
    def vehicle_factory(self, vehicle_id: int, gap_x_axis: float):
        ...
        # Add the camera to the multirotor configuration
        config_multirotor.graphical_sensors = [
            MonocularCamera(f"front_camera_{vehicle_id}", config={"depth": False, "frequency": 10.0, "resolution": (480, 480)})
        ]
        ...
        Multirotor(
            ...
            ROBOTS['Iris'],
            vehicle_id,
            [self.initial_position[0] + gap_x_axis * vehicle_id, self.initial_position[1], self.initial_position[2]],
